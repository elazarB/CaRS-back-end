...
exports.validateCars = (_reqBody) => {
  let joiSchema = Joi.object({
    ...
    access_amount:Joi.number.min(0).max(12000).allow(null, ""),
    compulsory_payment_arrangement: Joi.number().min(2).max(112030).allow(null, ""),
    third_party_payment_deployment: Joi.number().min(2).max(112030).allow(null, ""),
